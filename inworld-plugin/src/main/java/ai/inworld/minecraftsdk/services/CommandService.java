...
import ai.inworld.minecraftsdk.commands.APICommand;
import ai.inworld.minecraftsdk.commands.HelpCommand;
import ai.inworld.minecraftsdk.commands.RegisterCommand;
import ai.inworld.minecraftsdk.commands.SceneCommand;
...
public class CommandService implements CommandExecutor, TabCompleter {
    ...
    private final List<ai.inworld.minecraftsdk.commands.Command> commands;
    ...
    public boolean onCommand(@Nonnull CommandSender sender, @Nonnull Command command, @Nonnull String label, @Nonnull String[] args) {
        ...
        if (args.length > 0) {
            ...
            for (ai.inworld.minecraftsdk.commands.Command cmd : commands) {
    ...
    public @Nullable List<String> onTabComplete(@Nonnull CommandSender sender, @Nonnull Command command, @Nonnull String label, @Nonnull String[] args) {
        ...
        // logConsole(LogType.Info, "onTabComplete " + args.length);
        ...
        if (args.length > 0) {
            ...
            if (!foundCommand) {
                ...
                for (ai.inworld.minecraftsdk.commands.Command cmd : this.commands) {
                    if (sender.hasPermission(cmd.getPermission())) {
